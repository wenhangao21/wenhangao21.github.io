...
- $\[\mathcal{L}_{g = t}f\](x)=f\left(t^{-1} \odot x\right) = f(x - t)$: A translation of the function.
...
- $\[\mathcal{L}_{g = (t, \theta)}f\](\mathbf{x})=f\left(\mathbf{R}_\theta^{-1}(x-t)\right)$: A roto-translation of the image.
